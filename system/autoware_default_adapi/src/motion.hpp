...
private:
  ...
  Sub<autoware::universe_component_interface_specs::control::IsStartRequested> sub_is_start_requested_;
  ...
  void on_timer();
  void on_is_paused(
    const autoware::universe_component_interface_specs::control::IsPaused::Message::ConstSharedPtr msg);
  void on_is_start_requested(
    const autoware::universe_component_interface_specs::control::IsStartRequested::Message::ConstSharedPtr
      msg);
  void on_accept(
