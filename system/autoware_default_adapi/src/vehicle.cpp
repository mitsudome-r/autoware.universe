...
using HazardLightsReport = autoware::universe_component_interface_specs::vehicle::HazardLightStatus::Message;
using ApiHazardLight = autoware_adapi_v1_msgs::msg::HazardLights;
using MapProjectorInfo = autoware::universe_component_interface_specs::map::MapProjectorInfo::Message;
...
void VehicleNode::energy_status(
  const autoware::universe_component_interface_specs::vehicle::EnergyStatus::Message::ConstSharedPtr msg_ptr)
{
