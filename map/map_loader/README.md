...
Please see [tier4_autoware_msgs/msg/MapProjectorInfo.msg](https://github.com/tier4/tier4_autoware_msgs/blob/tier4/universe/autoware_map_msgs/msg/MapProjectorInfo.msg) for supported projector types.
