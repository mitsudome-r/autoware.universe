...
- input/ackermann_control_command [`autoware_control_msgs/msg/ControlHorizon`] : target command to drive a vehicle
- input/manual_ackermann_control_command [`autoware_control_msgs/msg/ControlHorizon`] : manual target command to drive a vehicle (used when control_mode_request = Manual)
