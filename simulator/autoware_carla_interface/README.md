...
| `use_pov_highway`                 | bool   | False                                                                             | Preset that loads the `PoV_Highway` map and spawns the `vehicle.carlamotors.european_hgv` truck at the `pov_highway_demo.py` location (road_id=2, lane_id=-2, s=500)                                                |
