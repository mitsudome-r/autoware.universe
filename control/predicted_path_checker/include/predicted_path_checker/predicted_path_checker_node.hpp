...
private:
  ...
  autoware::universe_component_interface_specs::control::IsStopped::Message::ConstSharedPtr is_stopped_ptr_{
    nullptr};
  ...
  void onIsStopped(
    const autoware::universe_component_interface_specs::control::IsStopped::Message::ConstSharedPtr msg);
